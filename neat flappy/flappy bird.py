...
def main(genomes, config):
    ...
    for _, g in genomes:  # genomes is tuple with id and obj
    ...
    while run:
        ...
        if add_pipe:
            score += 1
            for g in ge:
                g.fitness += 5  # all the birds here passed the pipe
...
def run(config_path):
    ...
    winner = p.run(main, 10)  # number of generations we are going to run
